...
import { fetchDisciplineDetails, updateDiscipline } from "../../../../../api/api__admin";
import Swal from "sweetalert2";
import { useNavigate, useParams } from "react-router-dom";
import { useQuery } from "react-query";

function DeciplineFormEdit() {
  const { id } = useParams();
  ...
  const { data: disciplineDetailsData, isLoading, error } = useQuery('disciplineDetailsData', () => fetchDisciplineDetails(id));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newDiscipline = await updateDiscipline(id,d);
      navigate("/admin/courses/decipline")
      Swal.fire(
    ...
    <div className="modalBackground">
      <div className="modalContainer">
        ...
        <div className="body_modal">
            <div className="form_group">
              ...
              <input
                ...
                value={disciplineDetailsData.titre}
            ...
            <div className="form_group">
                ...
                <textarea
                    ...
                    value={disciplineDetailsData.discipline_description}
        ...
        <div className="footer">
          ...
          <button type="submit" className="btn btn_style">Edit</button>
        </div>
      </div>
    </div>
    </form>
...
export default DeciplineFormEdit;
